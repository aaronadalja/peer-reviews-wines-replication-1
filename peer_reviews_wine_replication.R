...
htmlreg(list(tbl3[[2]][[1]][[6]], tbl3[[2]][[2]][[6]], tbl3[[2]][[3]][[6]], tbl3[[2]][[4]][[6]], tbl3[[2]][[5]][[6]], tbl3[[2]][[6]][[6]]), 
        file="./tbl3_2.doc", digits=3, caption.above=T, stars = c(0.01, 0.05, 0.1),
        caption = "Table 3, Base Period = Round 2",
        custom.model.names = c("FRH", "FRL", "SPH", "SPL", "NYH", "NYL"),
        custom.coef.map = list("pt.fr" = "FR", "pt.sp" = "SP", "pt.us" = "NY"),
        override.se = list(tbl3[[2]][[1]][[7]][,2], tbl3[[2]][[2]][[7]][,2], tbl3[[2]][[3]][[7]][,2], tbl3[[2]][[4]][[7]][,2], tbl3[[2]][[5]][[7]][,2], tbl3[[2]][[6]][[7]][,2]),
        override.pvalues = list(tbl3[[2]][[1]][[7]][,4], tbl3[[2]][[2]][[7]][,4], tbl3[[2]][[3]][[7]][,4], tbl3[[2]][[4]][[7]][,4], tbl3[[2]][[5]][[7]][,4], tbl3[[2]][[6]][[7]][,4]),
        custom.note = "Note: Robust standard errors are reported in parentheses. Asterisk (*), double asterisk (**), and triple asterisk (***) 
        indicate significance at the 10, 5 and 1 percent level, respectively. We include region fixed effects plus individual-level control 
        variables for age, gender, ethnicity, education, income, marital status, household size, and a dummy for whether the individual has children."
)

htmlreg(list(tbl3[[3]][[1]][[6]], tbl3[[3]][[2]][[6]], tbl3[[3]][[3]][[6]], tbl3[[3]][[4]][[6]], tbl3[[3]][[5]][[6]], tbl3[[3]][[6]][[6]]), 
        file="./tbl3_3.doc", digits=3, caption.above=T, stars = c(0.01, 0.05, 0.1),
        caption = "Table 3, Base Period = Round 3",
        custom.model.names = c("FRH", "FRL", "SPH", "SPL", "NYH", "NYL"),
        custom.coef.map = list("pt.fr" = "FR", "pt.sp" = "SP", "pt.us" = "NY"),
        override.se = list(tbl3[[3]][[1]][[7]][,2], tbl3[[3]][[2]][[7]][,2], tbl3[[3]][[3]][[7]][,2], tbl3[[3]][[4]][[7]][,2], tbl3[[3]][[5]][[7]][,2], tbl3[[3]][[6]][[7]][,2]),
        override.pvalues = list(tbl3[[3]][[1]][[7]][,4], tbl3[[3]][[2]][[7]][,4], tbl3[[3]][[3]][[7]][,4], tbl3[[3]][[4]][[7]][,4], tbl3[[3]][[5]][[7]][,4], tbl3[[3]][[6]][[7]][,4]),
        custom.note = "Note: Robust standard errors are reported in parentheses. Asterisk (*), double asterisk (**), and triple asterisk (***) 
        indicate significance at the 10, 5 and 1 percent level, respectively. We include region fixed effects plus individual-level control 
        variables for age, gender, ethnicity, education, income, marital status, household size, and a dummy for whether the individual has children."
)
...
## Appendix Table A1 - ROBUSTNESS CHECK FOR TABLE 3 ## 
# Round 1 vs. Round 2
# full controls
...
htmlreg(list(tbl4[[2]][[1]][[1]][[6]], tbl4[[2]][[1]][[2]][[6]], tbl4[[2]][[2]][[1]][[6]], tbl4[[2]][[2]][[2]][[6]]), 
        file="./tbl4_2.doc", digits=3, caption.above=T, stars = c(0.01, 0.05, 0.1),
        caption = "Table 4, Base Period = Round 2",
        custom.model.names = c("NYH, NY=No", "NYH, NY=Yes", "NYL, NY=No", "NYL, NY=Yes"),
        custom.coef.map = list("pt.fr" = "FR", "pt.sp" = "SP", "pt.us" = "NY"),
        override.se = list(tbl4[[2]][[1]][[1]][[7]][,2], tbl4[[2]][[1]][[2]][[7]][,2], tbl4[[2]][[2]][[1]][[7]][,2], tbl4[[2]][[2]][[2]][[7]][,2]),
        override.pvalues = list(tbl4[[2]][[1]][[1]][[7]][,4], tbl4[[2]][[1]][[2]][[7]][,4], tbl4[[2]][[2]][[1]][[7]][,4], tbl4[[2]][[2]][[2]][[7]][,4]),
        custom.note = "Note: Robust standard errors are reported in parentheses. Asterisk (*), double asterisk (**), and triple asterisk (***) 
        indicate significance at the 10, 5 and 1 percent level, respectively. We include region fixed effects plus individual-level control 
        variables for age, gender, ethnicity, education, income, marital status, household size, and a dummy for whether the individual has children."
)

htmlreg(list(tbl4[[3]][[1]][[1]][[6]], tbl4[[3]][[1]][[2]][[6]], tbl4[[3]][[2]][[1]][[6]], tbl4[[3]][[2]][[2]][[6]]), 
        file="./tbl4_3.doc", digits=3, caption.above=T, stars = c(0.01, 0.05, 0.1),
        caption = "Table 4, Base Period = Round 3",
        custom.model.names = c("NYH, NY=No", "NYH, NY=Yes", "NYL, NY=No", "NYL, NY=Yes"),
        custom.coef.map = list("pt.fr" = "FR", "pt.sp" = "SP", "pt.us" = "NY"),
        override.se = list(tbl4[[3]][[1]][[1]][[7]][,2], tbl4[[3]][[1]][[2]][[7]][,2], tbl4[[3]][[2]][[1]][[7]][,2], tbl4[[3]][[2]][[2]][[7]][,2]),
        override.pvalues = list(tbl4[[3]][[1]][[1]][[7]][,4], tbl4[[3]][[1]][[2]][[7]][,4], tbl4[[3]][[2]][[1]][[7]][,4], tbl4[[3]][[2]][[2]][[7]][,4]),
        custom.note = "Note: Robust standard errors are reported in parentheses. Asterisk (*), double asterisk (**), and triple asterisk (***) 
        indicate significance at the 10, 5 and 1 percent level, respectively. We include region fixed effects plus individual-level control 
        variables for age, gender, ethnicity, education, income, marital status, household size, and a dummy for whether the individual has children."
)
...
## Appendix Table A2 - ROBUSTNESS CHECK FOR TABLE 4 ##
# FRH and FRL
# base round 1, 2, 4
# full controls
...
## Appendix Table A4 - ROBUSTNESS CHECK FOR TABLE 5 ## 
# FRH and FRL
# base round 1, 2, 4
# full controls
